...
def notears_linear(X, lambda1, loss_type, max_iter=1000000, h_tol=1e-8, rho_max=1e+16, w_threshold=0.3):
...
def parse_args():
    ...
    parser.add_argument('--lambda1', type=float, default=0.0001, help='L1 regularization parameter')
...
if __name__ == '__main__':
    ...
    W_est = notears_linear(X, lambda1=args.lambda1, loss_type=args.loss_type)
    assert is_dag(W_est)
